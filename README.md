...
# 📖 Book Store Application<a name="about-project"></a>


Book Store application is an application that allows a user to do view a list of books, add a book, comment, edit and remove. I created the project using HTML, CSS, Javascript and react.
...
```sh
git clone git@github.com:sylvester-wamaya/book-store.git
```
